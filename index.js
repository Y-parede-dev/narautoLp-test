const CONTACT = `<div class="contact"><h3>contactez Nous</h3><a class="bold numero" href="tel:+33567069500" class="tel"><span class="fa fa-solid fa-phone"></span>05 67 06 95 00</a><div class="livraison no-mobile"><img class="logo" src="/logo.png" alt="logo" /><p> Livraison <strong class="bold">GRATUITE</strong></p></div></div>
